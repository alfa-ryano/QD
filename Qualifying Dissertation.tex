...
For an example, when the first time a player tries a new game, he undergoes concrete experience with the game (Concrete Experience phase). He then tries to identify and characterise the game through recalling any knowledge that is relevant to the game (Reflective Observation phase). Next, he constructs a definition of the game that he plays (Abstract Conceptualization phase). After constructing the definition, he the tries to apply the definition into the game (Active Experimentation phase), experience the result, (Concrete Experience phase again), and then evaluate whether the experience fits with the definition of the game or not (Reflective Observation again). Any gap that appears will update the existing definition to produce a new definition of the game (Abstract Conceptualisation) that will be implemented again in the next phase (Active Experimentation phase.
